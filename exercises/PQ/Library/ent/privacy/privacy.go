...
// The MagazineQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type MagazineQueryRuleFunc func(context.Context, *ent.MagazineQuery) error

// EvalQuery return f(ctx, q).
func (f MagazineQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.MagazineQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.MagazineQuery", q)
}

// The MagazineMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type MagazineMutationRuleFunc func(context.Context, *ent.MagazineMutation) error

// EvalMutation calls f(ctx, m).
func (f MagazineMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.MagazineMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.MagazineMutation", m)
}
...
// The NewspaperQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type NewspaperQueryRuleFunc func(context.Context, *ent.NewspaperQuery) error

// EvalQuery return f(ctx, q).
func (f NewspaperQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.NewspaperQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.NewspaperQuery", q)
}

// The NewspaperMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type NewspaperMutationRuleFunc func(context.Context, *ent.NewspaperMutation) error

// EvalMutation calls f(ctx, m).
func (f NewspaperMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.NewspaperMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.NewspaperMutation", m)
}
